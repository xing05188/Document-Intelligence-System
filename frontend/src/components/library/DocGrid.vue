  ...
  >
    ...
    <div v-if="isDragOver" class="drag-overlay">
      <div class="drag-inner">
        <span class="drag-icon"><SvgIcon name="inbox" :size="64" /></span>
    ...
    <div v-else-if="!libraryStore.currentSpaceId" class="docs-empty">
      <span class="empty-icon"><SvgIcon name="folder" :size="48" /></span>
      <h3>请先选择一个文档空间</h3>
    ...
    <div v-else-if="libraryStore.filteredDocs.length === 0" class="docs-empty">
      <span class="empty-icon"><SvgIcon name="empty" :size="48" /></span>
      <h3>该空间暂无文档</h3>
      ...
      <div class="modal-overlay" :class="{ active: showBatchDeleteModal }" @click.self="closeBatchDeleteModal">
        <div class="modal">
          ...
          <div class="modal-body">
            ...
            <div class="confirm-box">
              <div class="confirm-icon batch-icon"><SvgIcon name="warning" :size="32" /></div>
